        ...
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="flex-1">
                ...
                <div class="flex flex-wrap gap-3 justify-center md:justify-start">
                    ...
                    @endphp
                    @if($isComicOwner)
                    <a href="{{ route('user.chapters.create', $comic) }}" class="px-6 py-2.5 bg-gray-100 text-gray-700 font-bold rounded-lg border border-gray-300 shadow-lg hover:bg-gray-200 hover:-translate-y-0.5 transition-all flex items-center gap-2">
