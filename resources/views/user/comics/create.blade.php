...
@section('title', 'Đăng truyện mới')
@section('header', 'Đăng truyện mới')
...
<div class="p-8 max-w-7xl mx-auto space-y-6">
    ...
    {{-- MAIN FORM --}}
    <form id="create-comic-form" action="{{ route('user.comics.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="relative w-full max-w-xs mx-auto group">
                            <div class="relative w-full aspect-[2/3] bg-gray-50 rounded-xl border-2 border-dashed border-gray-300 overflow-hidden flex flex-col items-center justify-center transition-all group-hover:border-blue-400 group-hover:bg-blue-50/30 shadow-inner">
                                ...
                                <img id="cover-preview" src="#" class="absolute inset-0 w-full h-full object-cover hidden" alt="Preview">
                                    <input type="file" name="cover_image" id="cover_image" form="create-comic-form" class="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10" accept="image/*" onchange="previewCover(this)">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-full flex flex-col gap-6">
                ...
                <div class="flex gap-4 flex-shrink-0">
                    ...
                    <button type="submit" form="create-comic-form"
                        ...
                        <i class="fas fa-save mr-2"></i> Đăng truyện
                    </button>
                    </div>
                </div>
            </div>
